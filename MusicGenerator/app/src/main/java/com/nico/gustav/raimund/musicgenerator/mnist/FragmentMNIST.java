package com.nico.gustav.raimund.musicgenerator.mnist;
...
import com.nico.gustav.raimund.musicgenerator.MainActivity;
import com.nico.gustav.raimund.musicgenerator.R;
import com.nico.gustav.raimund.musicgenerator.mnist_model.DrawModel;
import com.nico.gustav.raimund.musicgenerator.mnist_model.DrawView;
...
public class FragmentMNIST extends Fragment implements View.OnClickListener, View.OnTouchListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.mnist_fragment, container, false);
    ...
    private void loadModel(final Activity activity) {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    mClassifiers.add(
                            TensorFlowClassifier.create(activity.getAssets(), "TensorFlow",
                                    "opt_mnist_convnet-tf.pb", "labels.txt", PIXEL_WIDTH,
                                    "input", "output", true));
                    mClassifiers.add(
                            TensorFlowClassifier.create(activity.getAssets(), "Keras",
